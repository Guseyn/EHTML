...
`}return d.trim()}),r.subParser('makeMarkdown.tableCell',function(e,u){'use strict';var d='';if(!e.hasChildNodes())return'';for(var a=e.childNodes,s=a.length,i=0;i<s;++i)d+=r.subParser('makeMarkdown.node')(a[i],u,!0);return d.trim()}),r.subParser('makeMarkdown.txt',function(e){'use strict';var u=e.nodeValue;return u=u.replace(/ +/g,' '),u=u.replace(/¨NBSP;/g,' '),u=r.helper.unescapeHTMLEntities(u),u=u.replace(/([*_~|`])/g,'\\$1'),u=u.replace(/^(\s*)>/g,'\\$1>'),u=u.replace(/^#/gm,'\\#'),u=u.replace(/^(\s*)([-=]{3,})(\s*)$/,'$1\\$2$3'),u=u.replace(/^( {0,3}\d+)\./gm,'$1\\.'),u=u.replace(/^( {0,3})([+-])/gm,'$1\\$2'),u=u.replace(/]([\s]*)\(/g,'\\]$1\\('),u=u.replace(/^ {0,3}\[([\S \t]*?)]:/gm,'\\[$1]:'),u});var x=this;typeof define=='function'&&define.amd?define(function(){'use strict';return r}):typeof B<'u'&&B.exports?B.exports=r:x.showdown=r}).call(W)});var T=se(K()),{helper:te,extensions:fe,setOption:oe,getOption:le,getOptions:he,resetOptions:pe,setFlavor:_e,getFlavor:me,getFlavorOptions:ge,getDefaultOptions:we,subParser:be,extension:ke,getAllExtensions:ve,removeExtension:ye,resetExtensions:Pe,validateExtension:ze,Converter:je}=T,Ce=T.default??T;export{je as Converter,Ce as default,ke as extension,fe as extensions,ve as getAllExtensions,we as getDefaultOptions,me as getFlavor,ge as getFlavorOptions,le as getOption,he as getOptions,te as helper,ye as removeExtension,Pe as resetExtensions,pe as resetOptions,_e as setFlavor,oe as setOption,be as subParser,ze as validateExtension}
/*! Bundled license information:

showdown/dist/showdown.js:
  (*! showdown v 2.1.0 - 21-04-2022 *)
*/
//# sourceMappingURL=showdown.mjs.map